...
public class SuperToggleRect extends ToggleableView {
    private int padding;
     ...
     */
    public SuperToggleRect(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
     ...
     */
    public SuperToggleRect(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        this.isOn = false;
        this.labelOn = "LINEAR VIEW";
        this.labelOff = "GRID VIEW";

        this.enabled = true;
        this.textSize = (int)(12f * getResources().getDisplayMetrics().scaledDensity);

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            colorBorder = colorOn = getResources().getColor(R.color.colorFirst, getContext().getTheme());
        } else {
            colorBorder = colorOn = getResources().getColor(R.color.colorSecond);
        }
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    accentColor = getResources().getColor(R.color.colorFirst, getContext().getTheme());
                } else {
                    accentColor = getResources().getColor(R.color.colorSecond);
                }
...
//    public SuperToggle() {
//        Log.d("bolgarchuk", "Test1 is here");
//    }
}
