...
public class SuperToggle extends ToggleableView {
        private int padding;
         ...
         */
        public SuperToggle(Context context) {
            super(context);
            initView();
        }
         ...
         */
        public SuperToggle(Context context, AttributeSet attrs) {
            super(context, attrs);
            initView();
         ...
         */
        public SuperToggle(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        private void initView() {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                colorBorder = colorOn = getResources().getColor(R.color.colorThird, getContext().getTheme());
            } else {
                colorBorder = colorOn = getResources().getColor(R.color.colorThird);
            }
        ...
        private void initProperties(AttributeSet attrs) {
            ...
            for (int i = 0; i < N; ++i) {
                ...
                if (attr == R.styleable.Toggle_on) {
                    ...
                    int accentColor;
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                        accentColor = getResources().getColor(R.color.colorThird, getContext().getTheme());
                    } else {
                        accentColor = getResources().getColor(R.color.colorThird);
                    }
